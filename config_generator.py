...
if __name__ == "__main__":
    ...
    for item in server_data:
        ...
        if server_type == "wireguard" and country_code != "au" and country_code != "br" and country_code != "ca" and country_code != "gb" and country_code != "hk" and country_code != "jp" and country_code != "nz" and country_code != "sg" and country_code != "us":
            #print(item)
